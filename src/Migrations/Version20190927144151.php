 ...
 */
final class Version20190927144151 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, utensil_id INTEGER DEFAULT NULL, title VARCHAR(100) NOT NULL, image VARCHAR(255) NOT NULL, cooking_time INTEGER NOT NULL, baking_time INTEGER NOT NULL, price INTEGER NOT NULL)');
